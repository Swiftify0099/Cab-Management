...
models_file = os.path.join(backend_dir, "common", "models", "all_models.py")
...
if "class TransportOrder" not in current:
    print("Writing to models_file:", models_file)
    with open(models_file, "a", encoding="utf-8") as f:
        f.write(feature17_models)
    print("Appended Feature 17 models successfully!")
else:
    print("Feature 17 models already exist in all_models.py")
