"""
Script to create RatingFeedbackService and patch matching router with Feature 17 endpoints.
Uses atomic PostgreSQL pg_insert.on_conflict_do_update for zero race-conditions.
"""
import os
import sys
...
# Write rating_feedback_service.py
service_file = os.path.join(services_dir, "rating_feedback_service.py")
with open(service_file, "w", encoding="utf-8") as f:
    f.write(RATING_SERVICE_CODE)
print(f"✓ Updated {service_file} with atomic pg_insert UPSERT")
