...
app.include_router(admin_kyc_router, prefix="/api/v1/admin/kyc", tags=["Admin KYC Review"])
...
app.include_router(vehicles_router, prefix="/api/v1/driver/vehicles", tags=["Multi-Vehicle Management"])
app.include_router(service_catalog_router, prefix="/api/v1", tags=["Service Catalog & Eligibility"])
app.include_router(driver_telematics_router, prefix="/api/v1/driver", tags=["Driver Availability & Telematics"])
