    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <p className="text-slate-500 text-sm">Coupon and referral management</p>
        </div>
      </div>
      <motion.div
      ...
      >
        ...
        <h2 className="text-xl font-display font-semibold text-slate-800 dark:text-white mb-2">Coupons Module</h2>
