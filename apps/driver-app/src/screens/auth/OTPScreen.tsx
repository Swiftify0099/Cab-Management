 ...
 * Exported from src/screens/auth/OTPScreen.tsx
 */
...
const styles = StyleSheet.create({
  ...
  brandIconMini: { width: 28, height: 28, borderRadius: 8 },
  ...
  subtitle: { color: '#94A3B8', fontSize: 13.5, textAlign: 'center', marginTop: 6 },
  phoneChip: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  phoneChipText: { color: '#FFFFFF', fontSize: 13.5, fontWeight: '700' },
  editPhoneBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 3,
  ...
  editPhoneText: { color: '#38BDF8', fontSize: 11.5, fontWeight: '700' },
  otpRow: {
    flexDirection: 'row',
    justifyContent: 'center',
    gap: 8,
  ...
  resendLink: { color: '#38BDF8', fontSize: 13, fontWeight: '700' },
  ...
  verifyBtnText: { color: '#FFFFFF', fontSize: 15, fontWeight: '800' },
  securityFooter: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 28 },
  securityFooterText: { color: '#64748B', fontSize: 11.5, fontWeight: '500' },
})
