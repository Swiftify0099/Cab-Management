    ...
    <View style={styles.root}>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Aadhaar & License Upload</Text>
        </View>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.cardWrapper}>
            <View style={styles.glassCard}>
              ...
              <View style={styles.cardHeader}>
                <Text style={styles.cardTitle}>Driver License Upload</Text>
        ...
        <View style={styles.bottomContainer}>
          ...
          >
            ...
            >
              <Text style={styles.proceedText}>Proceed to Selfie Verification</Text>
            </LinearGradient>
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  statusIconYellow: {
    ...
    height: 20,
    borderRadius: 10,
    backgroundColor: '#B45309', // Darker yellow/orange for the circle
    alignItems: 'center',
    justifyContent: 'center',
  },
  exclamationText: {
    color: '#FDE047', // Bright yellow for the !
    fontSize: 14,
    fontWeight: '800',
  },
  ...
  glowBg: {
    ...
    borderRadius: 25,
    filter: 'blur(10px)', // Only works on web, but box-shadow simulates it below
    shadowColor: '#3B82F6',
    shadowOpacity: 0.8,
    shadowRadius: 20,
